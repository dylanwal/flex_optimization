...
def main():
    ...
    # STOP CRITERIA
    # method = fo.methods.MethodRandom(problem, fo.stop_criteria.StopComputationTime(1))
    # method = fo.methods.MethodRandom(problem, [fo.stop_criteria.StopComputationTime(1), fo.stop_criteria.StopFunctionEvaluation(100)])
    # method = fo.methods.MethodRandom(problem, [[fo.stop_criteria.StopComputationTime(0.1), fo.stop_criteria.StopFunctionEvaluation(1000)]])
    # method = fo.methods.MethodRandom(problem, fo.stop_criteria.StopRelativeChange(cut_off_steps=10))
    ...
    # METHODS
    # method = fo.methods.MethodFactorial(problem=problem, levels=80)
    # method = fo.methods.MethodCovary(problem=problem, levels=10)
    # method = fo.methods.MethodMultiCovary(problem=problem, levels=10)
    ...
    # method = fo.methods.MethodBODragon(problem, stop_criteria=fo.stop_criteria.StopFunctionEvaluation(20))
    # method = fo.methods.MethodBFGS(problem, stop_criteria=fo.stop_criteria.StopFunctionEvaluation(20), x0=[3, 3])

    # multiprocessing
    # method = fo.methods.MethodFactorial(problem=problem, levels=50, multiprocess=True)
    # method = fo.methods.MethodBODragon(problem, stop_criteria=fo.stop_criteria.StopFunctionEvaluation(20), multiprocess=True,
